...
- Videos now play in the reader. An article holding a YouTube or Vimeo video, whether you saved the link yourself or it came embedded in the article, shows the thumbnail with a play button on it, and clicking that starts the player in place instead of sending you off to the video site. Nothing is requested from YouTube or Vimeo while you are merely reading: the thumbnail is all there is until you press play, so no video service learns which articles you opened unless you decide to watch. YouTube is loaded through youtube-nocookie.com, and the caption under the thumbnail says which site the player will come from. Videos in articles saved earlier play too, and where scripts cannot run, the thumbnail stays what it was, a plain link out to the video.
