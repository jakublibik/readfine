    ...
    async def security_headers(request, call_next):
        ...
        if not settings.debug:
            ...
            response.headers["Content-Security-Policy"] = (
                "default-src 'self'; "
                "script-src 'self' 'unsafe-eval' 'sha256-ALfIYnkYQB9eQSrlPaXs797oLbiBdUb9gezGsBHlQIc=' 'sha256-0uxrvilPUJCT3k/+dqd7J1+BNEI+pjD5pHGdBigJAS0=' 'sha256-C/IJM/tdPMbuZEi9IJcCEckQ8TRu+KznXpLAuGYGliw=' 'sha256-Ndjk6JNMLJ7YWddVtAwiNzMrOWCG3u03r3HXuWjNL/0=' 'sha256-yF/AgXJr5eU+0PI4tdElAq5mc3MPZWQhf3eCtLYeOYA=' 'sha256-fEeZZqxjvf8KnXGpUawHozmwW1PaiGqeIEY/BIC5WBE=' 'sha256-ieoeWczDHkReVBsRBqaal5AFMlBtNjMzgwKvLqi/tSU=' 'sha256-9i2VQpB8OdqYIGArEPf6WBbJCyznLjJxkkjGUlzXPsE=' 'sha256-4tqAJeNC8eld99ySgoI/c0sV4JdTD8GU5Utg3hCVvfE=' 'sha256-sQe7FWPjIbSL0WlmIHIwIdkg5DJrpr9Jh7z8VscIRG4=' 'sha256-Qg3X8MilaCm0DyUmYgpGr6Ak7XcyNG4P7fYBbx1w4HE='; "  # unsafe-eval: htmx.js; hashes: catch_me_up.html, main.html, scope_selector.html, share.html, preferences.html, scrape_setup.html + 2 unresolved
                "img-src * data:; "
