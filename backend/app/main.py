    ...
    async def security_headers(request, call_next):
        ...
        if not settings.debug:
            ...
            response.headers["Content-Security-Policy"] = (
                "default-src 'self'; "
                "script-src 'self' 'unsafe-eval' 'sha256-ieoeWczDHkReVBsRBqaal5AFMlBtNjMzgwKvLqi/tSU=' 'sha256-yF/AgXJr5eU+0PI4tdElAq5mc3MPZWQhf3eCtLYeOYA=' 'sha256-fEeZZqxjvf8KnXGpUawHozmwW1PaiGqeIEY/BIC5WBE='; "  # unsafe-eval: htmx.js; hashes: share.html, preferences.html, scrape_setup.html inline scripts
                "img-src * data:; "
