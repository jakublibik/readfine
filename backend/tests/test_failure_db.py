...
from app.fetcher.failure import BLOCK_BACKOFF_BASE, BLOCK_DISABLE_THRESHOLD, FETCH_ERROR_DISABLE_THRESHOLD
...
class TestErrorTierWrites:
    ...
    async def test_permanent_4xx_disables_immediately(self, pg):
